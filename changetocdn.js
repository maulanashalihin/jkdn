    ...
    for(var i=0;i<files.length;i++){
        ...
        if (stat.isDirectory()){
            ...
            try {
                ...
                let result = data.toString().replace('<link rel="stylesheet" href="./assets/css/main.css" />','<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jkdnmovie'+version+'/dist/assets/css/main.css" />')
